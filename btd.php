...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Binary to Decimal Online: Binary to Decimal">
    <meta name="title" content="Binary to Decimal Online">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | Binary to Decimal</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">Binary to Decimal</li>
</ul> 
