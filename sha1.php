...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="SHA1 Online: encode sha1, convert to sha1, text to sha1, string to sha1">
    <meta name="title" content="SHA1 Online | encode">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, sha1, sha1 encode">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/sha1">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | SHA1 Encoder</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">SHA1</li>
</ul> 
...
<div class="form-group">
    <input id="type" type="hidden" value="sha1" required></input>
</div>
<div class="form-group">
