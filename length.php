...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Convert length units online">
    <meta name="title" content="Easy Converter | Length Converter">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, Length, Length Converter">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/length">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | Length Converter</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">Length</li>
</ul> 
...
<div class="form-group">
    ...
    <select name="from" class="form-control bg-dark" id="from" required size="<?php echo count($converters['length']); ?>">
    <?php
    foreach($converters['length'] as $k => $a) {
    ?>
...
<div class="form-group">
    ...
    <select name="to" class="form-control bg-dark" id="to" required size="<?php echo count($converters['length']); ?>">
    <?php
    foreach($converters['length'] as $k => $a) {
    ?>
    <option value="<?php echo $k; ?>"><?php echo $a; ?></option>
...
<div class="form-group">
    <input id="type" type="hidden" value="length" required></input>
</div>
<div class="form-group">
