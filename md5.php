...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="MD5 Online: md5 hash string, md5, encode md5, md5 encode, md5 online">
    <meta name="title" content="MD5 Online | MD5 encoder">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, md5, md5 encode">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/md5">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>MD5 Online | MD5 encoder</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">MD5</li>
</ul> 
<h3>MD5 Encoder</h3>
<hr>
...
<div class="form-group">
    <input id="type" type="hidden" value="md5" required></input>
</div>
<div class="form-group">
