...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Decimal to Hex Online: Convert Decimal to Hex">
    <meta name="title" content="Decimal to Hex Online">
    ...
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/dth">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | Decimal to Hex</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">Decimal to Hex</li>
</ul> 
...
<div class="form-group">
    <input id="type" type="hidden" value="dth" required></input>
</div>
<div class="form-group">
