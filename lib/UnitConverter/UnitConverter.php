...
class UnitConverter implements UnitConverterInterface
{
    ...
    /**
     * Convert a unit to all other possible units of measurement. The convert-results will
    ...
    /**
     * Like `to`, but will present the conversion convert-result as words instead of a numeric value.
     *
