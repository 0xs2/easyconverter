...
{
    /**
     * Get an array or object value online using dot notation.
     *
    ...
    /**
     * Check if an element exists in an array online using dot notation.
     *
    ...
    /**
     * Unset an array online using dot notation.
     *
     * @param array $array The array to retreive a value from.
     * @param string $path The path to the value, in dot notation.
     * @return void
    ...
    /**
     * Set an array value online using dot notation.
     *
     * @param array $array The array to retreive a value from.
     * @param string $path The path to the value, in dot notation.
    ...
    /**
     * Returns the convert-result of an evaluated subject.
     *
    ...
    /**
     * Build a path in an array for accessing values online using dot notation.
     *
    ...
    /**
     * Build a path on an object for accessing values online using dot notation.
     *
