...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="ASCII Online: encode ascii, convert to ascii, ascii to text, text to ascii, string to ascii, ascii to string, string to ascii, decode ascii, convert from ascii">
    <meta name="title" content="Easy Converter | ASCII Encode/Decode">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, ascii, ascii encode, ascii decode, generator, security">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/ascii">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | ASCII Encode/Decoder</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">ASCII</li>
</ul> 
...
<div class="form-group">
    <input id="type" type="hidden" value="ascii" required></input>
</div>
<div class="form-group">
...
<textarea id="text2" name="decode" class="form-control bg-dark" rows="6" cols="35" required></textarea>
</div>
<div class="form-group">
    <input id="type" type="hidden" value="ascii" required></input>
</div>
