...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="HTML Entities Online: HTML Entities, HTML Entities decode, HTML Entities encode">
    <meta name="title" content="HTML Entities Online">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, HTML Entities, HTML Entities encode, HTML Entities decode, generator, security">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/html">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>HTML Entities Online</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">HTML Entities</li>
</ul> 
<h3>HTML Entities Encoder</h3>
<hr>
<form method="post" action="" id="encode"> 

<div class="form-group">
    <label for="encode">HTML to Encode</label>
    <textarea id="text" class="form-control bg-dark"name="encode" rows="6" cols="35"  required></textarea>
</div>
<div class="form-group">
    <input id="type" type="hidden" value="html" required></input>
</div>
<div class="form-group">
...
<h3>HTML Entities Decoder</h3>
<hr>
<form method="post" action="" id="decode">  
<div class="form-group">
    <label for="text">HTML to Decode</label>
