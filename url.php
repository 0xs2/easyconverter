...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Encode URL Online: url encode, online url encoder, how to encode url">
    <meta name="title" content="URL Encode Online">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, url encode, url, security">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/url">
...
<div class="form-group">
    <label for="text">URL to Encode</label>
    <input id="text" type="url" class="form-control bg-dark"name="encode" required></input>
</div>
<div class="form-group">
    <input id="type" type="hidden" value="url" required></input>
</div>
<div class="form-group">
