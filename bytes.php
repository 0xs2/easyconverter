...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Convert byte units online">
    <meta name="title" content="Easy Converter | Bytes Converter">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, bytes, bytes Converter">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/bytes">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | Bytes Converter</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">Bytes</li>
</ul> 

<h3>Bytes Converter</h3>
<hr>
...
<div class="form-group">
    ...
    <select name="from" class="form-control bg-dark" id="from" required size="<?php echo count($converters['bytes']); ?>">
    <?php
    foreach($converters['bytes'] as $k => $a) {
    ?>
...
<div class="form-group">
    ...
    <select name="to" class="form-control bg-dark" id="to" required size="<?php echo count($converters['bytes']); ?>">
    <?php
    foreach($converters['bytes'] as $k => $a) {
    ?>
    <option value="<?php echo $k; ?>"><?php echo $a; ?></option>
...
<div class="form-group">
    <input id="type" type="hidden" value="bytes" required></input>
</div>
<div class="form-group">
