...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Decimal to Octal Online: Convert Decimal to Octal">
    <meta name="title" content="Decimal to Octal Online">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, Octal Decimal, Octal to Decimal, Octal to Decimal">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/dto">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | Decimal to Octal</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">Decimal to Octal</li>
</ul> 
...
<div class="form-group">
    <input id="type" type="hidden" value="dto" required></input>
</div>
<div class="form-group">
