...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Convert speed units online">
    <meta name="title" content="Easy Converter | speed Converter">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, speed, speed Converter">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/speed">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | Speed Converter</title>
</head>
<?php
...
<div class="form-group">
    ...
    <select name="from" class="form-control bg-dark" id="from" required size="<?php echo count($converters['speed']); ?>">
    <?php
    foreach($converters['speed'] as $k => $a) {
    ?>
...
<div class="form-group">
    ...
    <select name="to" class="form-control bg-dark" id="to" required size="<?php echo count($converters['speed']); ?>">
    <?php
    foreach($converters['speed'] as $k => $a) {
    ?>
    <option value="<?php echo $k; ?>"><?php echo $a; ?></option>
...
<div class="form-group">
    <input id="type" type="hidden" value="speed" required></input>
</div>
<div class="form-group">
