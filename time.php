...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Convert Time online">
    <meta name="title" content="Easy Converter | Time Converter">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, time, time Converter">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/time">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | Time Converter</title>
</head>
<?php
...
<div class="form-group">
    ...
    <select name="from" class="form-control bg-dark" id="from" required size="<?php echo count($converters['time']); ?>">
    <?php
    foreach($converters['time'] as $k => $a) {
    ?>
...
<div class="form-group">
    ...
    <select name="to" class="form-control bg-dark" id="to" required size="<?php echo count($converters['time']); ?>">
    <?php
    foreach($converters['time'] as $k => $a) {
    ?>
    <option value="<?php echo $k; ?>"><?php echo $a; ?></option>
...
<div class="form-group">
    <input id="type" type="hidden" value="time" required></input>
</div>
<div class="form-group">
