...
<head>
  ...
  <meta name="author" content="sui">
    ...
    <meta name="description" content="Hex Online: encode hex, convert to hex, hex to text, text to hex, string to hex, hex to string, string to hex, decode hex, convert from hex">
    <meta name="title" content="Easy Converter | Hex Encode/Decode">
    <meta name="keywords" content="converter, units, encode, decoder, easy converter, Hex, Hex encode, Hex decode, generator, security">
    <meta name="theme-color" content="#131313">
    	<link rel="canonical" href="https://easyconverter.org/hex">
...
<script src="assets/js/clipboard.min.js"></script><?php include_once("includes/head.php"); ?>
    <title>Easy Converter | Hex Encode/Decoder</title>
</head>
<?php
...
<ul class="breadcrumb bg-dark">
  ...
  <li class="breadcrumb-item active">Hex</li>
</ul> 
<h3>Hex Encoder</h3>
<hr>
...
<div class="form-group">
    <input id="type" type="hidden" value="hex" required></input>
</div>
<div class="form-group">
